    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                ...
                <div className="bg-gradient-to-br from-dark-card to-gray-800 rounded-xl shadow-lg p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl opacity-60 cursor-not-allowed border border-dark-border">
                    <ChatIcon />
                    ...
                    <button
                        disabled
                        className="mt-auto px-6 py-2 bg-gray-600 text-white rounded-md cursor-not-allowed"
                    >
                        Coming Soon
                    </button>
                </div>
